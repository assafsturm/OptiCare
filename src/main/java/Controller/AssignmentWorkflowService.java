...
// controller service contract for optimization workflow operations.
public interface AssignmentWorkflowService {
    ...
    // Builds patient-level diff and score summary for preview
    ...
    // Admits patient into department waiting flow
    ...
    // Deterministic waiting queue view ordered by comparator
